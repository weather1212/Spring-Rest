package com.hoseong.spring.util;
...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath, String originalName, byte[] fileData) throws Exception {
		...
		// 파일 경로(기존의 업로드 경로 + 날짜별 경로), 파일명을 받아 객체 생성
		...
		if (MediaUtils.getMediaType(formatName) != null) {
			// 썸네일 생성
			uploadedFileName = makeThumbnail(uploadPath, savePath, savedName);
		} else { // 나머지는 아이콘
			// 아이콘 생성
			uploadedFileName = makeIcon(uploadPath, savePath, savedName);
		}
