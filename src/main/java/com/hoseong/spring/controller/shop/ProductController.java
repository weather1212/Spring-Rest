...
public class ProductController {
	...
	public String insert(ProductVO vo) {
		...
		if (!vo.getProductPhoto().isEmpty()) {
			...
			// 개발디렉토리 - 파일 업로드 경로
			// String path = "C:\\Git\\springBoard\\Spring-Shop\\src\\main\\webapp\\resources\\images";
			// 배포디렉토리 - 파일 업로드 경로
			String path = "C:\\Git\\springBoard\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\Spring-Shop\\resources\\images\\";
			try {
